...
Additionally, to satisfy the AEAD encryption preconditions, we have to show that there exists a label that flows to the encryption key and to which the secrecy label of the message flows.
