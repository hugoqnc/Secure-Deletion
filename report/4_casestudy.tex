...
\todo{Better reexplain this part}
...
\todo{This is a short part, maybe it can be merged or moved elsewhere}
...
This work is explained in the next section.
...
Indeed, at each round, a participant derives first a receiving key $K_{2n}$ and then a sending key $K_{2n+1}$, using the \texttt{ComputeKDFRatchet} function.
...
\todo{In the end, what was actually verified in our protocol? The result will depend on my progress on the implementation.}
