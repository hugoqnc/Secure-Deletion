...
\todo{This section uses the names “Alice” and “Bob” without introducing them.}
...
\todo{Remove the content that was already explained in section \ref{sec:dy-star}. If the remaining content is too small, move everything to Background.}
