...
The Diffie-Hellman (DH) Ratchet is a continuous key agreement protocol, that repeatedly performs Diffie-Hellman key exchanges to encrypt each message with its own key.
