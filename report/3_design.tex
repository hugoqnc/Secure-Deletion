...
\todo{Do they really support concurrency? See after}
...
% To support concurrency, we could protect the token factory with a lock.
...
To conclude, we have obtained a satisfactory approach to track the number of versioned values, that meet all of our requirements.
...
\todo{I don't explain why our approach supports concurrency}
...
To avoid this, we introduce \emph{frame checks} and leak checks.
% TODO_ explain what each check solve
